...
class TestTaskDependents:
    def test_task_takes_max_density_of_dependents_and_self(self) -> None:
        """
        Given a task
    ...
    def test_task_takes_max_density_of_effective_density(self) -> None:
        ...
        Then the task's effective_density should be the maximum of its own and
            the other's effective density
        """
        child2 = Task.new(
            name="hello",
            importance=8,
    ...
    def test_removing_dependent_task_leads_to_correct_density(self) -> None:
        """
        Given a task with a dependency
    ...
    def test_task_will_ignore_effective_density_of_inactive_tasks(self) -> None:
        """
